...
from modules.practicum import render_practicum
from modules.quiz import render_quiz
from modules.dataset_loader import load_dataset

# Page Configuration
st.set_page_config(
    page_title="Data Mining — Decision Tree & Naive Bayes",
    page_icon="./",
    layout="wide",
...
# Sidebar
with st.sidebar:
    st.markdown("## Perkuliahan Data Mining")
    st.markdown("**Rahmad Ade Akbar, S.Pd., M.Pd**")
    st.image(
    ...
    st.markdown(
        ...
        **Perkuliahan Data Mining** tentang
        membangun model prediksi menggunakan:
        - **Decision Tree**
        - **Naive Bayes**
...
st.markdown(
    ...
    <div class="main-header">
        <h1>Perkuliahan Data Mining</h1>
        <p>Membangun Model Prediksi — Klasifikasi Data dengan Decision Tree & Naive Bayes</p>
    </div>
    """,
    unsafe_allow_html=True,
)
...
elif menu == "Latihan Praktikum":
    render_practicum(df, feature_names, target_name, target_labels, dataset_choice)
elif menu == "Soal Praktikum":
    render_quiz()
